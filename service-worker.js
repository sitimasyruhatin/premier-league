...
workbox.precaching.precacheAndRoute(
  [
    ...
    { url: '/src/assets/images/default-logo.webp', revision: '1' },
    { url: '/src/assets/images/heading.webp', revision: '1' },
    { url: '/src/assets/images/icon-512x512.webp', revision: '1' },
    { url: '/src/assets/images/icon-192x192.webp', revision: '1' },
    { url: '/src/assets/images/icon-filled-192x192.webp', revision: '1' },
    { url: '/src/assets/images/maskable_icon.webp', revision: '1' },
